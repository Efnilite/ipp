            ...
            if (args[0].equalsIgnoreCase("lobbygm") && player != null && ParkourOption.ADMIN.check(sender)) {
                ...
                switch (args[1]) {
                    ...
                    case "save" -> {
                        ...
                        Selection selection = new Selection(existingSelection[0], existingSelection[1]);
                        ...
                        if (dimensions.getWidth() < LobbyMode.MINIMUM_SIZE ||
                            ...
                            Util.send(player, IPP.PREFIX + "You haven't made the area big enough! " +
                                    "It needs to be at least <bold>" + LobbyMode.MINIMUM_SIZE + "</bold> blocks in all directions.");
                            return true;
                        }
